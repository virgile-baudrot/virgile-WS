...
Two references are unavoidable, the [Hadley's style guide](http://adv-r.had.co.nz/Style.html) and the [Google's R style guide](https://google.github.io/styleguide/Rguide.xml). And also [*The R Inferno* by Patrick Burns](http://www.burns-stat.com/pages/Tutor/R_inferno.pdf)

Has Hadley wrote, the most important is to have a consistent and clear style.
